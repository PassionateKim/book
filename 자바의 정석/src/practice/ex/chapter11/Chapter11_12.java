...
public class Chapter11_12 {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("-------[Chapter11_13]---------");
        //[Chapter-13]
        SutdaDeck deck2 = new SutdaDeck();
        deck2.shuffle();
        ...
        TreeMap rank = new TreeMap(new Comparator<Player>() {
            ...
            public int compare(Player o1, Player o2) {
                return (o1.point - o2.point) * (-1); // 내림차순
            }
        });//TreeMap

        for (int i = 0; i < pArr.length; i++) {
            Player p = pArr[i];
            rank.put(p, deck2.getPoint(p));
            System.out.println(p+""+deck2.getPoint(p));
        }
...
class SutdaDeck {
    ...
    HashMap jokbo = new HashMap(); // 족보를 저장할 해시 맵
    ...
    int getPoint(Player player) {
        ...
        SutdaCard c1 = player.c1;
        SutdaCard c2 = player.c2;
